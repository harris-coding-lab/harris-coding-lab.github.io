...
example_vec  == ______ 
```
**Answer A:** It will be `c(0, 0, 0, 1, 10)`.
**Answer B:** It will be `c(10, 3, 2, -1, -12)`.
...
```
**Answer A:** It will be `c(10, 0, 2, 1, -12)`.
**Answer B:** It will be `c(10,0,2,0,-12)`.
...
**Answer :** 
my_tibble <- my_tibble %>%
  mutate(is_prime = ifelse(my_vec %in% c(2, 3, 5, 7), "TRUE", "FALSE"))
...
```
**Answer :** shed_data <- read_dta("data/shed_data_abridged.dta")
