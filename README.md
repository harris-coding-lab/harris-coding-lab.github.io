...
|**Class 5: Visualizing data with `ggplot`**| [video](https://youtu.be/0MIeGk_xwiQ) (~ 21 min) | [slides](slides/05_ggplot.pdf) <br> slide code to come[](code/05_ggploy.R)| Work on final project with TA and peer support | |
