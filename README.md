...
|**Class 2: Vectors and Data Types**|- [video](https://youtu.be/0MIeGk_xwiQ) <br> (~  22 min)| - [slides](slides/02_vectors-and-data-types.pdf) <br> - [slide code](code/02_vectors-and-data-types.R) | - [lab 2](lab/02_vectors_and_dtypes.pdf) <br> - [lab 2 Rmd template](lab/lab_templates/lab_2.Rmd) <br> - [basics review](lab/02_basics_vectors_and_datatypes.pdf) <br> <!-- - [solved lab](lab/02_vectors_and_dtypes_solutions.pdf)--> | - [lab code](lab/02_vectors_and_dtypes.R) |
