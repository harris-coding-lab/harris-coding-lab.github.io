...
|**Class 3a: If Statements** | - [video](https://www.youtube.com/watch?v=HKC7RTpNt60) <br> (~  20 min) | - [slides](slides/03_if-statements.pdf) <br> - [slide code](code/03_if-statements.R)  |  - [basic review](lab/03_basics_if_else.pdf) <br> <br> - [fall_lab_3](https://github.com/harris-coding-lab/harris-coding-lab.github.io/raw/master/fall_labs/if-statements/if-statements.zip) (zip file) | - [push lab 3](lab/03_if_statements.pdf) <br> - [push lab 3a Rmd template](lab/lab_templates/lab_3.Rmd) <br> - [solved push lab](lab/03_if_statements_solution.pdf)|
