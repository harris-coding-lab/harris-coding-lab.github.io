...
## Again, better in context of map() 
...
```
This is doing the same work as our for-loop from last week. For more information on the `map()` family of functions,  see appendix. 
