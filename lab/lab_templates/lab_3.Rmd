...
Whichever you chose, write the code in the following code chunk. Notice the above chunk says `eval = FALSE` in the curly brakets and so will not run (evaluate) the code when you knit.
