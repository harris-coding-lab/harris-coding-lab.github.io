...
We expect you to watch the `class 1` material, [here](harris-coding-lab.github.io) prior to lab. If you find yourself in lab without R installed, try using RStudio cloud [https://rstudio.cloud/]( https://rstudio.cloud/).^[Sign up for the free tier which should be sufficient for camp. You will have to install packages.]
...
1. What's the total area of Illinois? You probably have no idea what the units are though. If you google, you'll find that it doesn't align perfectly with online sources. Given the units don't align with other sources, can this data still be useful?
