...
1. Adjust the following code block to read in the provided data set `incarceration_counts_and_rates_by_type_over_time.xlsx`
...
1. Adjust the call to median, so that we ignore the NA value and return 3.
